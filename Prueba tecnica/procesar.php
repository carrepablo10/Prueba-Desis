...
$descubrimiento = $_POST["checkbox"];

foreach ($descubrimiento as $key => $value) {
    $ficha="INSERT INTO persona SET descubrimiento = $value";
    $sql = "INSERT INTO persona (nombre_apellido, alias, email, rut, region, comuna, candidato, descubrimiento) VALUES ('$nombreyapellido', '$alias', '$email', '$rut', '$region','$comuna','$candidato','$value')";
